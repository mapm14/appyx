 ...
 *
 * Implement either [onBackPressedCallback] or [onBackPressedCallbacks], not both.
...
interface BackPressHandler : Plugin {
    ...
    val onBackPressedCallbacks: List<OnBackPressedCallback>
        get() = listOfNotNull(onBackPressedCallback)

    fun handleOnBackPressed(): Boolean =
        onBackPressedCallbacks.any { callback ->
